...
ALTER TABLE granit_kontakty ADD CONSTRAINT granit_kontakty_kontakty_cat_id_granit_kontakty_cat_id FOREIGN KEY (kontakty_cat_id) REFERENCES granit_kontakty_cat(id) ON DELETE CASCADE;
